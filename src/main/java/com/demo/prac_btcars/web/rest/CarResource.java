...
import com.demo.prac_btcars.repository.CarRepository;
import com.demo.prac_btcars.repository.search.CarSearchRepository;
...
public class CarResource {
    ...
    public ResponseEntity<List<Car>> getCompanyCars(@RequestParam String company) {
        log.debug("Rest request to search cars for querry by company", company);
        String make = null;
    ...
    @Timed
    public ResponseEntity<List<Car>> getCategory(@RequestParam String category){
        log.debug("REST request to get cars for query by category", category);
        List<Car> cars = null;
